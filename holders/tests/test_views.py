...
class TestHolderViews(TestCase):
    def setUp(self):
        ...
        permission_add_holder = Permission.objects.get(content_type=content_type, codename="add_holder")
        permission_change_holder = Permission.objects.get(content_type=content_type, codename="change_holder")
        permission_delete_holder = Permission.objects.get(content_type=content_type, codename="delete_holder")
