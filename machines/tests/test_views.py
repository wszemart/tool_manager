...
class TestMachineViews(TestCase):
    def setUp(self):
        ...
        permission_add_machine = Permission.objects.get(content_type=content_type, codename="add_machine")
        permission_change_machine = Permission.objects.get(content_type=content_type, codename="change_machine")
        permission_delete_machine = Permission.objects.get(content_type=content_type, codename="delete_machine")
        ...
        self.data = {"name": "Test Machine", "description": "Test description"}
