...
from .views import (ToolAssemblyCreateView, ToolAssemblyDeleteView, ToolAssemblyDetailView,
                    ToolAssemblyListView, ToolAssemblyUpdateView, ToolAssemblyAddCommentView)
...
urlpatterns = [
    ...
    path('tool-assembly/<int:pk>/add-comment/', ToolAssemblyAddCommentView.as_view(), name='add-comment'),
]
