...
from ..views import (ToolAssemblyListView, ToolAssemblyCreateView, ToolAssemblyDeleteView,
                     ToolAssemblyUpdateView, ToolAssemblyDetailView, ToolAssemblyAddCommentView)
