...
class TestToolViews(TestCase):
    def setUp(self):
        ...
        permission_add_tool = Permission.objects.get(content_type=content_type, codename="add_tool")
        permission_change_tool = Permission.objects.get(content_type=content_type, codename="change_tool")
        permission_delete_tool = Permission.objects.get(content_type=content_type, codename="delete_tool")
